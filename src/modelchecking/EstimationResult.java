...
public class EstimationResult implements Result {
  public double t0;
  public double t1;
  public double p;
  public int n;
  ...
  public String toString() {
    String result = "*** Interval Estimation Results ***" + Conf.newline;
    result += " - Interval: ["+t0+", "+t1+"]" + Conf.newline;
    result += " - Probability: " + p + Conf.newline;
